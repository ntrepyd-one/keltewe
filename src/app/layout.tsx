...
const SITE_TITLE = "Keltewe — Sovereign Awareness";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Keltewe — Sovereign Awareness | Geospatial Intelligence Platform",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Keltewe — Sovereign Awareness Platform",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ Keltewe — Sovereign Awareness | Live Intelligence Platform",
...
const jsonLd = {
  ...
  "@type": "WebApplication",
  name: "Keltewe — Sovereign Awareness Platform",
  alternateName: ["Keltewe", "intel.papic.ch"],
  url: SITE_URL,
  description: SITE_DESCRIPTION,
