...
export async function GET() {
  try {
    const url = 'https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&minmagnitude=2.0&minlatitude=-56.0&maxlatitude=-17.5&minlongitude=-75.6&maxlongitude=-66.0&orderby=time&limit=100';
    ...
    const earthquakes = (data.features || []).map((f: any) => {
      ...
      return {
        ...
        felt: props.felt, alert: props.alert, region: 'chile',
      };
    });
