            ...
            <div className="flex items-center gap-[2px] mb-3 z-[2]">
              {'Keltewe'.split('').map((letter, i) => (
                <motion.span
                  ...
                  style={{ color: 'var(--text-heading)', textShadow: '0 0 30px rgba(201,166,70,0.2)' }}
                >
                  {letter}
                </motion.span>
              ))}
                ...
                <div className="px-3 pb-3">
                  <div className="flex items-center justify-between mb-2">
                    <span className="hud-text text-[9px] text-[var(--text-primary)]">
                      {mobilePanel === 'layers' ? 'LAYERS & STATS' : mobilePanel === 'markets' ? 'MARKETS & INTEL' : mobilePanel === 'intel' ? 'INTEL FEED' : mobilePanel === 'recon' ? 'NTREPYD RECON' : 'SEARCH'}
                    </span>
